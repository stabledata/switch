...
export const BinaryIconToggle = React.forwardRef<
  React.ElementRef<typeof Button>,
  BinaryIconToggleProps
>(({ onIcon, offIcon, value, onSwitch, className, ...props }, ref) => {
  ...
  return (
    <Button
      ref={ref}
      variant="outline"
      className={cn("relative overflow-hidden h-10 group", className)}
      {...props}
      onClick={() => {
        setJustToggled(true);
